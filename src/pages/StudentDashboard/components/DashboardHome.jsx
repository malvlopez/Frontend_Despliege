const DashboardHome = () => {
  const activeRoutes = [
    { id: 1, title: 'Dominio de Subredes VLSM', source: 'Material de Redes de Computadores', progress: 65, type: 'official', colorTheme: 'blue' },
    { id: 2, title: 'Integración React & Express', source: 'Ruta Generada por IA', progress: 12, type: 'ai', colorTheme: 'emerald' }
  ];
